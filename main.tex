...
this paper focuses on the impact maximization and the trajectory of the hammer tip to the nail using QP.
...
Simulations were done using mc\_mujoco and mc\_rtc with its QP solver \cite{singhMcmujocoSimulatingArticulated2022} \cite{mcrtc} in torque control mode with a timestep $\Delta t = 0.002$s 
