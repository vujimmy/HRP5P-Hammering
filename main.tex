...
\begin{document}
\title{\LARGE \bf QP-based hammering task for a humanoid robot that leverages effective mass maximization for optimizing configuration at impact
\thanks{}
}
...
In this paper, The setting to complete this task is has a fixed hammer in one of the robots' grippers, a fully known position and orientation of the nail and a prefixed desired hitting velocity of the hammer tip on the nail. 
...
\end{equation}
To implement our EMMT task in mc\_rtc, we will modify (\ref{Global QP}) to include the EMMT within the posture task and we finally have :
\begin{equation}
